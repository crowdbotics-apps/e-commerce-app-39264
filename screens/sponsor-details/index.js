...
const SponsorDetails = () => {
  ...
  useEffect(() => {
    setSponsor({
      ...
      email: "Email",
      phone: "Phone",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam feugiat tellus a mattis ornare. Fusce sit amet libero id est iaculis hendrerit in quis nibh. "
    });
  }, []);
  return <View style={styles.container}>
      <Image style={styles.image} source={require("./assets/sponsorImage.png")} />
      <View style={styles.body}>
        <Image style={styles.sliderIcon} source={require("./assets/sliderIcon.png")} />
        ...
        <View style={styles.flexRow}>
          <Image style={styles.icon} source={require("./assets/callIcon.png")} />
        ...
        <Pressable style={styles.roundButton}>
          <Image style={styles.roundButtonImage} source={require("./assets/giftIcon.png")} />
