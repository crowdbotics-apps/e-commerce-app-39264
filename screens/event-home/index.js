...
const UpcomingEvent = ({
  ...
  return <View style={upcomingEventStyles.container}>
      <Image source={require("./Group 354.png")} style={upcomingEventStyles.image} />
      <View style={upcomingEventStyles.content}>
        <Text style={upcomingEventStyles.title}>Big Discount</Text>
